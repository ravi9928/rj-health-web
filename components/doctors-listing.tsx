                ...
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <div className="flex items-center space-x-1 text-gray-600">
                      ...
                      <span className="text-xs">{doctor.availability.split(":")[0]}</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-3 space-y-2">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-teal-600">₹{doctor.consultationFee.first}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-600">Follow-up:</span>
                      <span className="font-bold text-teal-600">₹{doctor.consultationFee.followup}</span>
                    </div>
                  </div>
